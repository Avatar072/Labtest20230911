...
generatefolder(filepath + "\\dataset_AfterProcessed\\", "After_PCA")
generatefolder(filepath + "\\dataset_AfterProcessed\\After_PCA\\", today)

# Loading datasets after label_Encoding
# mergecompelete_dataset = pd.read_csv(filepath + "\\dataset_AfterProcessed\\Train_Test_Network_AfterProcessed_updated_10000.csv")
mergecompelete_dataset = pd.read_csv(filepath + "\\dataset_AfterProcessed\\CIC-ToN-IoT_AfterProcessed_updated_10000.csv")
...
raw_train = mergecompelete_dataset.drop("Attack",axis=1)
...
# plt.show()
plt.savefig(filepath + "\\dataset_AfterProcessed\\After_PCA\\" +today+f"\\Feature choose_{today}.jpg")
plt.close("all")
...
finalDf = pd.concat([data1, mergecompelete_dataset[['Attack']]], axis = 1)
...
label_counts = test_dataframes['Attack'].value_counts()
print("test_dataframes\n", label_counts)
print("test_dataframes\n", test_dataframes.shape)
label_counts = train_dataframes['Attack'].value_counts()
print("train_dataframes\n", label_counts)
print("train_dataframes\n", train_dataframes.shape)

# SaveDataToCsvfile(train_dataframes, f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"train_dataframes_{today}")
# SaveDataToCsvfile(test_dataframes, f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"test_dataframes_{today}")
SaveDataToCsvfile(train_dataframes, f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"train_dataframes_{today}")
SaveDataToCsvfile(test_dataframes, f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"test_dataframes_{today}")
...
train_half1,train_half2 = splitdatasetbalancehalf(train_dataframes,'Attack')
...
printFeatureCountAndLabelCountInfo(train_half1, train_df_half2,'Attack')

# SaveDataToCsvfile(train_dataframes, f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"train_dataframes_{today}")
# SaveDataToCsvfile(test_dataframes,  f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"test_dataframes_{today}")
# SaveDataToCsvfile(train_half1, f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"train_half1_{today}")
# SaveDataToCsvfile(train_half2,  f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"train_half2_{today}") 

# SaveDataframeTonpArray(test_dataframes, f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", "test_ToN-IoT_afterPCA",today)
# SaveDataframeTonpArray(train_dataframes, f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", "train_ToN-IoT_afterPCA",today)
# SaveDataframeTonpArray(train_half1, f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", "train_half1_ToN-IoT_afterPCA", today)
# SaveDataframeTonpArray(train_half2, f"./TON_IoT Datasets/UNSW-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", "train_half2_ToN-IoT_afterPCA", today)

#CIC_ToN_IoT
SaveDataToCsvfile(train_dataframes, f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"train_dataframes_{today}")
SaveDataToCsvfile(test_dataframes,  f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"test_dataframes_{today}")
SaveDataToCsvfile(train_half1, f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"train_half1_{today}")
SaveDataToCsvfile(train_half2,  f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", f"train_half2_{today}") 

SaveDataframeTonpArray(test_dataframes, f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", "test_CIC_ToN-IoT_afterPCA",today)
SaveDataframeTonpArray(train_dataframes, f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", "train_CIC_ToN-IoT_afterPCA",today)
SaveDataframeTonpArray(train_half1, f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", "train_half1_CIC_ToN-IoT_afterPCA", today)
SaveDataframeTonpArray(train_half2, f"./TON_IoT Datasets/CIC-ToN-IoT/dataset_AfterProcessed/After_PCA/{today}", "train_half2_CIC_ToN-IoT_afterPCA", today)