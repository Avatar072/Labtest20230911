...
# x_test = np.load(filepath + "x_test_AfterPCA23_20240125.npy", allow_pickle=True)
# y_test = np.load(filepath + "y_test_AfterPCA23_20240125.npy", allow_pickle=True)
...
x_test = np.load(filepath + "x_test_AfterPCA3_20240125.npy", allow_pickle=True)
y_test = np.load(filepath + "y_test_AfterPCA3_20240125.npy", allow_pickle=True)
