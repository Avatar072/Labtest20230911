...
def spilttrainhalfAfterSMOTE(X_res,y_res):
    ...
    SaveDataToCsvfile(train_half1, f"{filepath}/dataset_AfterProcessed/ALL_Label/SMOTE/{today}/{client_str}/{file}_AfterSMOTEspilthalf", f"train_half1_AfterSMOTEspilt_{today}")
    SaveDataToCsvfile(train_half2,  f"{filepath}/dataset_AfterProcessed/ALL_Label/SMOTE/{today}/{client_str}/{file}_AfterSMOTEspilthalf", f"train_half2_AfterSMOTEspilt_{today}") 
    SaveDataframeTonpArray(train_half1, f"{filepath}/dataset_AfterProcessed/ALL_Label/SMOTE/{today}/{client_str}/{file}_AfterSMOTEspilthalf", "train_half1_AfterSMOTEspilt", today)
    SaveDataframeTonpArray(train_half2, f"{filepath}/dataset_AfterProcessed/ALL_Label/SMOTE/{today}/{client_str}/{file}_AfterSMOTEspilthalf", "train_half2_AfterSMOTEspilt", today)
...
def SMOTEParameterSet(choose_strategy, choose_k_neighbors,x_train, y_train, Label_encode):
        ...
        plt.legend()
        plt.savefig(f"{filepath}/dataset_AfterProcessed/ALL_Label/SMOTE/{today}/{client_str}/Label{Label_encode}/SMOTE_Samples_Original_Label_{Label_encode}.png")
        ...
        # 添加圖例
        plt.legend()
        plt.savefig(f"{filepath}/dataset_AfterProcessed/ALL_Label/SMOTE/{today}/{client_str}/Label{Label_encode}/SMOTE_Samples_After_SMOTE_Label_{Label_encode}.png")   
        plt.show()
        return X_res, y_res

def DoALLWeakLabel(x_train,y_train, ChooseLabel, Choose_totaltrain):
    
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\SMOTE\\{today}\\', client_str)
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\SMOTE\\{today}\\{client_str}\\', f'{ChooseLabel}')
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\SMOTE\\{today}\\{client_str}\\', "Label1")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\SMOTE\\{today}\\{client_str}\\', "Label3")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\SMOTE\\{today}\\{client_str}\\', "Label4")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\SMOTE\\{today}\\{client_str}\\', "Label6")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\SMOTE\\{today}\\{client_str}\\', "Label9")
    ...
    # # total_train
    sampling_strategy_Label1 = {1: 11993}
    sampling_strategy_Label3 = {3: 11969}
    sampling_strategy_Label4 = {4: 1231}
    sampling_strategy_Label6 = {6: 12020}
    sampling_strategy_Label9 = {9: 11918}

    # #client1
    # sampling_strategy_Label9 = {3: 4500}
    # sampling_strategy_Label1 = {1: 5997}
    # sampling_strategy_Label3 = {3: 5985}
    # sampling_strategy_Label4 = {4: 615}
    # sampling_strategy_Label6 = {6: 6010}
    # sampling_strategy_Label9 = {9: 5959}
    

    # #client2
    # sampling_strategy_Label1 = {1: 5996}
    # sampling_strategy_Label3 = {3: 5984}
    # sampling_strategy_Label4 = {4: 616}
    # sampling_strategy_Label6 = {6: 6010}
    # sampling_strategy_Label9 = {9: 5959}
    ...
    if(Choose_totaltrain != True):
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label1, 5, x_train, y_train, 1)
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label3, 5, X_res, y_res, 3)
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label4,5, X_res, y_res, 4)
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label6,5, X_res, y_res, 6)
    ...
    np.save(f"{filepath}\\dataset_AfterProcessed\\ALL_Label\\SMOTE\\{today}\\{client_str}\\{ChooseLabel}\\x_{file}_SMOTE_{ChooseLabel}_{today}.npy", X_res)
    np.save(f"{filepath}\\dataset_AfterProcessed\\ALL_Label\\SMOTE\\{today}\\{client_str}\\{ChooseLabel}\\y_{file}_SMOTE_{ChooseLabel}_{today}.npy", y_res)
...
def BorderLineParameterSet(choose_strategy, choosekind, choose_k_neighbors,choose_m_neighbors,x_train, y_train, Label_encode):
        ...
        plt.scatter(x_train_Label_Oringinal[:, 0], 
                ...
                label=f'Original Samples (Label {Label_encode}): {len(x_train_Label_Oringinal)})')
        plt.legend()
        plt.savefig(f"{filepath}/dataset_AfterProcessed/ALL_Label/BorederlineSMOTE/{choosekind}/{today}/{client_str}/Label{Label_encode}/BorederlineSMOTE_{choosekind}_Samples_Original_Label_{Label_encode}.png")
        plt.show()
        # 繪制SMOTE採樣後的數據中的標籤 weakLabel
        plt.scatter(X_resampled_Label_SMOTE[:, 0], 
                    X_resampled_Label_SMOTE[:, 1], 
        ...
        # 添加圖例
        plt.legend()
        plt.savefig(f"{filepath}/dataset_AfterProcessed/ALL_Label/BorederlineSMOTE/{choosekind}/{today}/{client_str}/Label{Label_encode}/BorederlineSMOTE_{choosekind}_Samples_Label_{Label_encode}.png")
        plt.show()
        return X_res, y_res
...
def DoBorederlineSMOTE(x_train, y_train,choosekind,ChooseLable):
    # 產生存檔分類用資料夾
    generatefolder(filepath, "ALL_Label")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\', "BorederlineSMOTE")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\', choosekind)
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\', today)
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\{today}\\', client_str)
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\{today}\\{client_str}\\', f'{ChooseLable}')
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\{today}\\{client_str}\\', "Label1")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\{today}\\{client_str}\\', "Label3")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\{today}\\{client_str}\\', "Label4")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\{today}\\{client_str}\\', "Label6")
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\{today}\\{client_str}\\', "Label9")
    ...
    # y_res = y_res.astype(int)
    y_train = y_train.astype(int)
    X_res, y_res = BorderLineParameterSet(sampling_strategy_Label1, choosekind, 5, 10, x_train, y_train, 1)
    X_res, y_res = BorderLineParameterSet(sampling_strategy_Label3, choosekind, 5, 10, X_res, y_res, 3)
    X_res, y_res = BorderLineParameterSet(sampling_strategy_Label4, choosekind, 5, 10, X_res, y_res, 4)
    X_res, y_res = BorderLineParameterSet(sampling_strategy_Label6, choosekind, 5, 10, X_res, y_res, 6)
    ...
    # np.save(f"{filepath}"+f'dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\{today}\\{client_str}\\{ChooseLable}\\x_{file}_BorederlineSMOTE_{choosekind}_{ChooseLable}_{today}.npy', X_res)
    # np.save(f"{filepath}"+f'dataset_AfterProcessed\\ALL_Label\\BorederlineSMOTE\\{choosekind}\\{today}\\{client_str}\\{ChooseLable}\\y_{file}_BorederlineSMOTE_{choosekind}_{ChooseLable}_{today}.npy', y_res)
    np.save(f'x_{file}_BorederlineSMOTE_{choosekind}_{ChooseLable}_{today}.npy', X_res)
    np.save(f'y_{file}_BorederlineSMOTE_{choosekind}_{ChooseLable}_{today}.npy', y_res)

# DoALLWeakLabel(x_train,y_train,"Label1_and_Label3_Label4_Label6_Label9", True)
# DoALLWeakLabel(x_train,y_train,"Label1_and_Label3_Label4", True)
# DoALL_Label(x_train,y_train)
# DoBorederlineSMOTE(x_train, y_train,"borderline-1","Label1_and_Label3_Label6")
# DoBorederlineSMOTE(x_train, y_train,"borderline-1","Label1_and_Label3_Label4_Label6_Label9")
# DoBorederlineSMOTE(x_train, y_train,"borderline-2","Label1_and_Label3_Label6")
DoBorederlineSMOTE(x_train, y_train,"borderline-2","Label1_and_Label3_Label4_Label6_Label9")
